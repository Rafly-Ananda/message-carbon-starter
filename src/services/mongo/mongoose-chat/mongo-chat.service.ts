...
import * as paginateHelper from "src/helpers/mongob-paginate-response";
import { TypeormMongoPaginate } from "src/interfaces/mongodb-paginate.interface";
...
export class MongoChatService {
  ...
  async findOne(): Promise<Chat> {
    return this.chatModel.findOne({
      sendTime: "2022-10-10T03:05:45.316255Z",
    }).exec();
  }
